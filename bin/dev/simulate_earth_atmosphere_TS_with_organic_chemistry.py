...
def simulate_NIST(s,o,a):
    ...
    nu,bio_trans,s.max_signal = o.calculate_convolve(s.nu, s.Bio_Transit_Signal,True)
    ...
    bond = [[2500,3200,"O-H"],[1650,1800,"C=O"],[1150,1040, "C-O"],[2200,2000,"C=C"],
            [1365,1120,"C-F"],[830,560,"C-Cl"],[680,515,"C-Br"],[525,475,"C-I"]]
    
    sim_plot.plot_bond_location(bond,s.max_signal)
