...
if __name__ == "__main__":
    ...
    user_input["Atmosphere_Effects"]["Bio_Molecule"]["data_type"] = "Exomol"
    user_input["Atmosphere_Effects"]["Bio_Molecule"]["molecule"] = "PH3"
    user_input["Atmosphere_Effects"]["Bio_Molecule"]["abundance"] = 1*10**-6
    user_input["Atmosphere_Effects"]["Bio_Molecule"]["is_smile"] = True
    user_input["Save"]["Intermediate_Data"]["bio_cross_section_savename"] = "Exomol_PH3.npy"
